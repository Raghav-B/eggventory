    ...
    public String execute(StockList list, Gui gui, Storage storage) {
        ...
        if (this.options == null) {
            ...
            try {
                ...
                gui.print("Error in reading help.txt");
            }
        } else {
            switch (this.options) {
            case "add":
                ...
                try {
                    ...
                    gui.print("Error in reading Helpadd.txt");
                }
                break;
            case "edit":
                ...
                try {
                    ...
                    gui.print("Error in reading Helpedit.txt");
                }
                break;
            ...
            case "delete":
                ...
                try {
                    ...
                    gui.print("Error in reading Helpdelete.txt");
                }
                break;
            default:
                gui.print("Your help command is not defined. Please enter 'help' for reference.");
            }
        }
        return output;
    }
