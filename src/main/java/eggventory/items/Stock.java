...
public class Stock {
     ...
     */
    public ArrayList<String> getTableFormat() {
        ArrayList<String> tableFormat = new ArrayList<>();
        tableFormat.add(stockType);
        tableFormat.add(stockCode);
        tableFormat.add(String.valueOf(quantity));
        tableFormat.add(description);
        return tableFormat;
    }
}
